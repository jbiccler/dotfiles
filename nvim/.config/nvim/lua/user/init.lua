...
local config = {
        ...
        mappings = {
                ...
                n = {
                        ...
                        ['<leader>ss'] = { '<C-w>s', desc = 'Split horizontal' },
                        ['<leader>se'] = { '<C-w>=', desc = 'Splits equal width' },
                        ...
                        ['<leader>R'] = { [[:silent !tmux send-keys -t 1 "\!\!" Enter <CR>]],
                                desc = 'Execute last tmux command' },
                        ['<leader>r'] = { [[:silent !tmux send-keys -t 1 "python " %:p Enter <CR>]],
                                desc = 'Execute Python' },
                        -- hop
